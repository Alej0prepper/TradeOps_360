...
8. **Operador:** devuelve dos unidades de A mediante Inventario, actualizando la cantidad entregada según la política estándar del caso. Comprueba entrega neta A = 8, pendiente = 2 y reapertura de distribución. Una nueva entrega válida de esas dos unidades elimina el pendiente.
